...
- Open `.env.example`, rename it to `.env` and enter your API-Key, URL, Space-ID and Deployment-ID, then save the file
  ...
  * Find your Space-ID in your IBM Cloud Pak for Data --> Deployment Spaces --> Your Deployment Space --> Manage --> Space GUID (alternatively you can also find it in the URL)
